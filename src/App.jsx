...
function App() {
  ...
  return (
    <div className="mt-52">
      <section className="sm:px-[1.5rem] sm:py-[2.5rem] lg:px-[2rem] bg-[radial-gradient(56.8%_50%_at_50%_50%,#ffeccc_0,hsla(0,0%,100%,0)_100%)] max-w-[80rem] mx-auto  ">
        ...
        <div className="mx-auto relative w-[.25rem] overflow-visible">
